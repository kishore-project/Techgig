...
<html>
<head>
<title>With the trendiest, freshest, and most unique styles from across India and the world, BoltzFashion invites you to express your personal style fearlessly, and with a confidence and optimism that cannot be easily shaken</title>
<!--/tags -->
...
<!--//tags -->
<link href="boltzmod/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="boltzmod/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="boltzmod/css/font-awesome.css" rel="stylesheet"> 
<link href="boltzmod/css/easy-responsive-tabs.css" rel='stylesheet' type='text/css'/>
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="Bolthomepage.html"><span>B</span>oltz Fashion <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
	...
	<div class="container">
			  ...
			  <div class="container-fluid">
				...
				<!-- 	<li class="active menu__item menu__item--current"><a class="menu__link" href="index.html">Home <span class="sr-only">(current)</span></a></li> -->
					...
					<li class="menu__item dropdown">
					   <a class="menu__link" href="BoltzMenColl.jsp"><!--  class="dropdown-toggle" --> <!-- data-toggle="dropdown"> --> Men's Wear <b class="caret"></b></a>
					...
					<li class="dropdown menu__item">
						<a href="BoltzWomenCol.jsp" class="dropdown-toggle menu__link" ><!-- data-toggle="dropdown"  --><!-- role="button" aria-haspopup="true" aria-expanded="false" -->Women's wear <span class="caret"></span></a>
							<!-- <ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="BoltzWomenCol.jsp"><img src="images/top1.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul> -->
					...
					<li class="menu__item dropdown">
					   <a class="menu__link" href="BoltzKidCollec.jsp"><!--  class="dropdown-toggle" --> <!-- data-toggle="dropdown"> --> Kids <b class="caret"></b></a>
					<!-- 			<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="icons.html">Web Icons</a></li>
									<li><a href="typography.html">Typography</a></li>
								</ul> -->
					...
					<li class=" menu__item"><a class="menu__link" href="index.html">Logout</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
		...
		<div class="top_nav_right">
			<div class="wthreecartaits wthreecartaits2 cart cart box_1"> 
						...
						<a href="boltzordershopping.jsp"><button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button></a>
	...
	<div class="schedule-bottom">
		...
		<div class="col-md-6 agileits_schedule_bottom_right">
			<div class="w3ls_schedule_bottom_right_grid">
				<h3>Save up to <span>50%</span> </h3>
				<p>boltzdesign has been designing suits since 1889, imbibing the gold standard of tailoring. The Core Shop boasts a range of choices for everyday elegance with a wide range of blazers to 3 piece suits, any selection is crafted from the highest quality fabrics designed specifically for your comfort. The Ceremony Edit weaves together the celebratory color and prints of festivals that are deep-rooted in Indian culture, with the finesse of world-class tailoring</p>
	...
	<!-- /we-offer -->
		<div class="sale-w3ls">
			<div class="container">
				...
				<a class="hvr-outline-out button2" href="OthersBrand.jsp">Shop Now </a>
			</div>
		</div>
	<!-- //we-offer -->
<!--/grids-->
		...
		<div class="coupons-grids text-center">
			<div class="w3layouts_mail_grid">
				...
				<div class="col-md-3 w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>24/7 SUPPORT</h3>
						<p>Front slits are trending in the fashion world and ethnic designs have also adopted the trend. We would recommend opting for a printed front-slit suit when you are heading to an office party. Team it with palazzos and high heels for a stylish look.</p>
					</div>
				</div>
				<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			...
			<p>In the present era of westernization, Indian women have become pretty conscious about their looks. With more and more women entering the workforce it has given a great impetus to the fashion industry. The latest trend that is boasting of its style is that of Indo-western fusion women wear which is classic and stylish just apt for the working women.</p>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="about.html">OtherBrand&&OfferBrands</a></li>
...
<script src="boltzmod/js/easy-responsive-tabs.js"></script>
<script>
...
<!-- //script for responsive tabs -->		
<!-- stats -->
	<script src="boltzmod/js/jquery.waypoints.min.js"></script>
	<script src="boltzmod/js/jquery.countup.js"></script>
	<script>
		$('.counter').countUp();
	</script>
<!-- //stats -->
