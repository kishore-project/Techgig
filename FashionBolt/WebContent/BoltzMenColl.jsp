...
<div class="ban-top">
	<div class="container">
		...
		<!-- 			<li class="dropdown menu__item menu__item--current">
						<a href="OthersBrand.jsp" class="dropdown-toggle menu__link" role="button" aria-haspopup="true" aria-expanded="false">Other Brands <span class="caret"></span></a>
					...
					<li class="dropdown menu__item">
						<a href="BoltzWomenCol.jsp" class="dropdown-toggle menu__link" role="button" aria-haspopup="true" aria-expanded="false">Women's wear <span class="caret"></span></a>
							<!-- <ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="boltzmod/images/banner2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="boltzmod/images/banner5.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="boltzmod/images/banner2.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					<h4>Mens Wear <span>Collection</span></h4>
					<p> </p>
				</div>
				<div class="clearfix"></div>
			</div>
											...
											<div class="men-pro-item simpleCart_shelfItem">
												<div class="men-thumb-item">
													<img data-enlargable  src="<%=Image%>"  alt="" border=3 height=300px width=300px class="pro-image-front">
														...
														<h4> <a href="#"><%=BrandName%></a> <label><%=BrandName %></label></h4>
														...
														<input type="number" name="qtn" value="1"> -->
															...
															<!-- 			<form action="boltzordershopping.jsp" method="post" >	 -->
																		<form action="BoltzMenColl_DB.jsp" method="post" >	
