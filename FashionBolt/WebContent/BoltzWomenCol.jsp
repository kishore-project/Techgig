	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>Boltz</span>Fashion<i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
...
<div class="ban-top">
	<div class="container">
		<div class="top_nav_left">
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item"><a class="menu__link" href="Bolthomepage.jsp">Home <span class="sr-only">(current)</span></a></li>
				<!-- 	<li class=" menu__item"><a class="menu__link" href="about.html">shipping status</a></li> -->
					<li class="dropdown menu__item menu__item--current">
						<a href="#" class="dropdown-toggle menu__link" role="button" aria-haspopup="true" aria-expanded="false">Men's wear <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<!-- <div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="boltzmod/images/top2.jpg" alt=" "/></a>
									</div> -->
			...
			<!-- 		<li class="dropdown menu__item">
						<a href="OthersBrand.jsp" class="dropdown-toggle menu__link" role="button" aria-haspopup="true" aria-expanded="false">Brand Offers<span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="boltzmod/images/top1.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
					...
					<li class="dropdown menu__item">
						<a href="BoltzKidCollec.jsp" class="dropdown-toggle menu__link" role="button" aria-haspopup="true" aria-expanded="false">Kids's wear <span class="caret"></span></a>
				</li>
				<!-- 	<li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">Brand Offers<b class="caret"></b></a>
...
<div class="page-head_agile_info_w3l">
 ...
 <%String namemale="female"; %>
  <!-- banner-bootom-w3-agileits -->
  <%

String BrandName=null,Details=null,Size1=null,Size2=null,Size3=null,Size4=null,MRP=null,SellPrice=null,ProductId=null,Discount=null,Category=null,Gender=null,Image=null,Sleeves=null,Wear=null,Quantity=null,TotQun=null,ExpDate=null;
  
  
	String Disprice=null,Offer=null;int Calprice=0; int Cal=0 ,a=0,lcal=0;	float cc=0,ab=0,calcution=0,f=0;
  try	{
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="boltzmod/images/wh3.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="boltzmod/images/wh6.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="boltzmod/images/wh7.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="boltzmod/images/wh1.jpg" alt=" " />
				</div>
				<div class="col-sm-8 men-wear-right">
					<h4>Women Wear <span>Collection</span></h4>
					<p> </p>
				</div>
				<div class="clearfix"></div>
			</div>
				...
				<div class="col-md-4 product-men">
											<div class="men-pro-item simpleCart_shelfItem">
												<div class="men-thumb-item">
													<img data-enlargable  src="<%=Image%>"  alt="" border=3 height=300px width=300px class="pro-image-front">
														<img data-enlargable  src="<%=Image%>" alt="" border=3 height=300px width=300px  alt="" class="pro-image-back">
														...
														<input type="number" name="qtn" value="1"> -->
															...
															<!-- 			<form action="boltzordershopping.jsp" method="post" >	 -->
																		<form action="BoltzWomenCol_DB.jsp" method="post" >	
																		Qty:<input type="number" name="qtn" max=10 pattern="[0-9]{2}" value=<%=Quantity%>>
																				 <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2"> 
														
																				<fieldset>
																				<!-- 	<input type="hidden" name="add" value="1"> -->
																			<input type="hidden" name="item_nameId1" value=<%=ProductId%>>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>Boltz E</span>lite Shoppy </a></h2>
		...
		<div class="col-md-9 footer-right">
			...
			<!-- 	<div class="col-md-5 sign-gd-two">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="single.html"><img src="boltzmod/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="boltzmod/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
