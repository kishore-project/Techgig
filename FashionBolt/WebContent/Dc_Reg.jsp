...
if (email==null || email==""){  
  ...
  return false;  
	...
	return false;
						...
						<form action="Dc_RegVal" method="post" autocomplete="off" name="form">
							<div class="content-wthree1">
								...
								<center><label class="header">UserName<span>*</span></label>	</center>
									...
									<input type="submit"  name="submit" value="Register" onclick="return validateform(document.form.email)">
						</div>
								</div>
							</div>
					</div>
