var cart = {
  ...
  load : () => {
    ...
    alert("Hello! I am an load");}
    else { cart.items = JSON.parse(cart.items); 
    alert("Hello! I am an unload");}
  },
  ...
  init : () => {
    ...
    alert("Hello! I am an hPdt");
    cart.hItems = document.getElementById("cart-items");
    alert("Hello! I am an hItem");
