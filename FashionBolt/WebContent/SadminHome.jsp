...
<!-- Custom Theme files -->
<link href="sadmin_home/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
<link href="sadmin_home/css/style.css" type="text/css" rel="stylesheet" media="all"> 
<link rel="stylesheet" href="sadmin_home/css/swipebox.css">     
<link href="sadmin_home/css/animate.css" rel="stylesheet" type="text/css" media="all"> <!-- animation -->
<link href="sadmin_home/css/font-awesome.css" rel="stylesheet"> <!-- font-awesome icons -->
<!-- //Custom Theme files --> 
<!-- js -->
<script src="sadmin_home/js/jquery-2.2.3.min.js"></script> 
<!-- //js -->
<!-- web-fonts -->
...
<body>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-center w3l-effect">
							...
							<li><a href="" class="scroll">Portfolio</a></li>
	...
	<div id="services" class="services">
		...
		<div class="container">
			...
			<script src="sadmin_home/js/waypoints.min.js"></script> 
			<script src="sadmin_home/js/counterup.min.js"></script> 
			<script>
	...
	<div id="portfolio" class="portfolio">
		<div class="container">
			...
			<!-- ResponsiveTabs -->
			<script src="sadmin_home/js/easyResponsiveTabs.js" type="text/javascript"></script>
			...
			<!-- //ResponsiveTabs -->
			<!-- swipe box js -->
			<script src="sadmin_home/js/jquery.swipebox.min.js"></script> 
				<script type="text/javascript">
					jQuery(function($) {
						$(".swipebox").swipebox();
					});
	...
	<!-- //copy right -->
	<!-- animation --> 
	<script src="sadmin_home/js/wow.min.js"></script>
	<script>
		 new WOW().init();
	</script>
	<!-- //animation --> 
	<!-- start-smooth-scrolling -->
	<script type="text/javascript" src="sadmin_home/js/move-top.js"></script>
	<script type="text/javascript" src="sadmin_home/js/easing.js"></script>	
	<script type="text/javascript">
			jQuery(document).ready(function($) {
    ...
    <script src="sadmin_home/js/bootstrap.js"></script>
</body>
</html>