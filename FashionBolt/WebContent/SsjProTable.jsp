...
<input type="file"><a href="" class="btn btn-outline-info" >Submit</a> -->
	<%
		...
		try {
			...
			qtr = "select * from decryptionkey where user_Name='" + req
					+ "' and decriptionid='0' and user_area='Ssj'";
			qtr2 = "select * from decryptionkey where user_Name='" + req
					+ "' and selcprocss='accepted' and user_area='Ssj'";
			String query = "select count(*) from decryptionkey where user_Name='" + req + "' and user_area='Ssj'";
			...
			if(rsl.next())
			{
				...
				<div class="container">
					<h1>
						<span style="color: green">Ssj</span>
						<button class='btn btn-success pull-right'>
							...
							<div class="row justify-content-center">
								<div class="col-md-6 text-center mb-5">
									<h1 class="heading-section">ssj product details</h1>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
												...
												<tbody>
													...
													<%
														try {
																		...
																		String query2 = "select * from ssjproduct";
	...
	<div class="container">
		<h1>
			...
			<form action="KeyRequest_Page.jsp" method="post">
				<input type="hidden" name="user" value="Ssj">
								...
								<tbody>
									...
									<%
										try {
														...
														Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fashion", "root",
																"root");
														String query2 = "select * from ssjproduct_encry";
														PreparedStatement ps1 = con.prepareStatement(query2);
														ResultSet s = ps1.executeQuery();
														while (s.next()) {
									%>
	...
	<%
		} else if ((rs.getString(2).equals(req) && rs.getString(5).equals("ssjproduct")) && rs.getString(3).equals("accepted") ) {
	%>
	...
	<div class="container">
		<h1>
			...
			<button class='btn btn-success pull-right'>
				...
				<div class="row justify-content-center">
					<div class="col-md-6 text-center mb-5">
						<h1 class="heading-section">Ssj details</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
  ...
  <div class="button-container">
    <button  class="yes-button"><a href="KeyRequest_Page.jsp?user=Ssj">Yes</a></button>
