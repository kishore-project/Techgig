...
<input type="file"><a href="" class="btn btn-outline-info" >Submit</a> -->
	<%
		...
		try {
			...
			qtr = "select * from decryptionkey where user_Name='" + req
					+ "' and decriptionid='0' and user_area='boltz'";
			qtr2 = "select * from decryptionkey where user_Name='" + req
					+ "' and selcprocss='accepted' and user_area='Viendia'";
			String query = "select count(*) from decryptionkey where user_Name='" + req + "' and user_area='Viendia'";
						...
						<button class='btn btn-success pull-right'>
							...
							<div class="row justify-content-center">
								<div class="col-md-6 text-center mb-5">
									<h1 class="heading-section">Viendia product details</h1>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
												...
												<tbody>
													...
													<%
														try {
																		...
																		String query2 = "select * from viendiaproduct";
	...
	<div class="container">
		<h1>
			<span style="color: green">Viendia product</span>
			<button class='btn btn-success pull-right'>
				<a href="Admin_cusOrd.jsp">Back</a>
			...
			<form action="KeyRequest_Page.jsp" method="post">
				<input type="hidden" name="user" value="Viendia">
								...
								<tbody>
									...
									<%
										try {
														...
														Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fashion", "root",
																"root");
														String query2 = "select * from viendiaproduct_encry";
														PreparedStatement ps1 = con.prepareStatement(query2);
														ResultSet s = ps1.executeQuery();
														while (s.next()) {
									%>
  ...
  <div class="button-container">
    <button  class="yes-button"><a href="KeyRequest_Page.jsp?user=Viendia">Yes</a></button>
