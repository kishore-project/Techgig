...
<% String bargopt=request.getParameter("dis");
if(bargopt.equals("Yes"))
{
%>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Bargain Request Details</h2>
                </div>
                <div class="card-body">
               ...
               String Bmail=(String)session.getAttribute("mailto");
				...
				String query="select * from customerorderlogin where email='"+Bmail+"'";
				  PreparedStatement ps1=con.prepareStatement(query);
				  ResultSet rs1=ps1.executeQuery();
				  if(rs1.next())
				  {
				
					  System.out.println("Bname"+"    "+rs1.getString("username"));
				
				String query2="select * from productorreq where brandname='"+rs1.getString("username")+"'";
			  ...
			  
			  {
                %>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                   <input class="input--style-5" type="text" name="gen1">
...
{
	RequestDispatcher r=request.getRequestDispatcher("cus_log.jsp");
