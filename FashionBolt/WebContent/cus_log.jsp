...
<body style="background-image: url('logos.jpeg'); width:100%; height:100%; object-fit: cover;background-repeat:no-repeat;background-attachment: fixed;background-size: cover;" >
    ...
    <form action="Cus_OrdVaL.jsp" method="post">
        <h3>Client Login</h3>

        <label for="username">Username</label>
        <input type="text" placeholder="Email or Phone" id="username" name="mail" >
        ...
        <div class="social">
          ...
          <a href="cus_regster.jsp"><div class="fb"> Register</div></a>
        </div>
    </form>
</body>
</html>
