...
<input type="file"><a href="" class="btn btn-outline-info" >Submit</a> -->
	<%
		...
		try {
			...
			qtr = "select * from decryptionkey where user_Name='" + req
					+ "' and decriptionid='0' and user_area='Boltz_Pay'";
			qtr2 = "select * from decryptionkey where user_Name='" + req
					+ "' and selcprocss='accepted' and user_area='Boltz_Pay'";
			String query = "select count(*) from decryptionkey where user_Name='" + req + "' and user_area='Boltz_Pay'";
												...
												<tbody>
													...
													<%
														try {
																		...
																		String query2 = "select * from userpaymentdetail";
								...
								<tbody>
									...
									<%
										try {
														...
														Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fashion", "root",
																"root");
														String query2 = "select * from userpaymentdetail_encry";
														PreparedStatement ps1 = con.prepareStatement(query2);
														ResultSet s = ps1.executeQuery();
														while (s.next()) {
									%>
  ...
  <div class="button-container">
    <button  class="yes-button"><a href="KeyRequest_Page.jsp?user=Boltz_Pay">Yes</a></button>
...
"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js">
	...
	<body  style="background-image: url('ka.jpg'); width:100%; height:100%; object-fit: cover;background-repeat:no-repeat;background-attachment: fixed;background-size: cover;">
<!-- <!-- <form action="boltzorder_update.jsp" method="post">
<input type="file"><a href="" class="btn btn-outline-info" >Submit</a></form> -->
<!-- 	<section class="ftco-section">
		<div class="container">
...
<% 
 String req=(String)session.getAttribute("Admail");
		...
		try
		{
		    Class.forName("com.mysql.jdbc.Driver");
					Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/fashion","root","root");
					qtr="select * from decryptionkey where user_Name='"+req+"' and decriptionid='0' and user_area='Boltz_Pay'";
					String query="select count(*) from decryptionkey where user_Name='"+req+"'";
					ResultSet rs=con1.prepareStatement(qtr).executeQuery();
					ResultSet rset=con1.prepareStatement(query).executeQuery();
					if(rs.next() && rset.next()){
					int cnt=rset.getInt(1);
					System.out.println(rs.getString(3).equals("rejected")  );
					System.out.println(rs.getString(4).equals("0")  );
					System.out.println("count"+cnt+"       iuerui0e               "+rs.getString(4) +"            "+rs.getString(3)+"      user"+rs.getString(2)+"  "+rs.first());
		...
		<div class="container">
		        <h1>
		      <span style="color:green">Boltz Payment</span>
		      <button class='btn btn-success pull-right'><a href="dc_Homepag.jsp" >Back</a>
		...
		<form action="KeyRequest_Page.jsp" method="post">
			...
			%>
				...
				<% }
					...
					else if(rs.getString(2).equals(req) && rs.getString(3).equals("selected")) 
					{
					%>
