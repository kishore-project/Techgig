    ...
    <div class="custom-header-bg">
      <div class="page-center">
        ...
        <div class="navigation">
          <ul>
            <li><a href="" class="button click-upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i>View</a></li>
...
<div class="body-container-wrapper">
  <div class="body-container">
   ...
   <form  action="orgupdateStaergies.jsp" method="post" >
        <div id="drop">
        <div class="box"> <strong><label >StartUp Client Upload</label></strong></div>
 
  <h1>Upload Your <strong>Files</strong>Startups</h1>
  <br></br>
