        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Bargain Product Details</h2>
                </div>
                <div class="card-body">
                <form action="updBargainfrmAdmin.jsp" method="post">
                <%
              ...
              String Bqun=(String)session.getAttribute("getQun");
                ...
                String Bgen=(String)session.getAttribute("Gen");
                try
			     {
			    Class.forName("com.mysql.jdbc.Driver");
				Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/fashion","root","root");
				String query2="select * from productorreq where brandname='"+Bname+"'";
