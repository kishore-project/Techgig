...
<body>
	<div data-vide-bg="video2/patient">
		<div class="center-container">
			<h1 class="header-w3ls">Register</h1>
...
if (email==null || email==""){  
  ...
  return false;  
	...
	return false;
						...
						<form action="Startupsreg" method="post">
							<div class="content-wthree1">
								<div class="grid-agileits1">
									...
									<div class="form-control">	
										...
										<input type="text" id="name" name="password" placeholder="Password" title="Please enter your Phone Number" required="">
									</div>
									<div class="form-control">	
										<label class="header">cnPassword <span>*</span></label>
										<input type="text" id="name" name="cnpassword" placeholder="Confirm Password" title="Please enter your Phone Number" required="">
									</div>
