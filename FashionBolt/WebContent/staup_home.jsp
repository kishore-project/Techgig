...
<!-- menu -->
<link type="text/css" rel="stylesheet" href="startup_assert/css/cm-overlay.css" />
<!-- //menu -->
<link href="startup_assert/css/jquery.fatNav.css" rel="stylesheet" type="text/css">
<!--FlexSlider-->
<link rel="stylesheet" href="startup_assert/css/flexslider.css" type="text/css" media="screen" />
<!--//FlexSlider-->
<!-- custom css theme files -->
<link rel="stylesheet" href="startup_assert/css/bootstrap.css" type="text/css" media="all">
<link rel="stylesheet" href="startup_assert/css/font-awesome.css" />
<link rel="stylesheet" href="startup_assert/css/style.css" type="text/css" media="all">
<!-- //custom css theme files -->
<!-- google fonts -->
	...
	<div class="w3layouts-nav-right">
		<div class="fat-nav">
			<div class="fat-nav__wrapper">
				<ul>
					<li><a href="startbuss.jsp">Start</a></li>
					<li><a href="startgery.jsp">Statergy</a></li>
					<li><a href="surveystat.jsp">Survey</a></li>
		...
		<h3 class="w3ls-title text-uppercase text-center">our education</h3>
			<div class="row ban_form mt-3 pt-md-5">
				...
				<div class="col-lg-4 reg-fom">
					<h4 class="text-white text-center">Courses Search</h4>
						<form action="#" method="post">
							<div class="reg-fom-btm mt-5">
								<div class="fields">
									<span class="text-white mb-2">Select Degree</span>
										<select class="form-control">
													...
													<option>GED</option>
													<option>Doctorate/Prof Degree</option>
							...
							<div class="reg-fom-btm mt-3">
								<div class="fields">
									<span class="text-white mb-2">Ceategory</span>
										<select class="form-control">
													<option>Master's Degree</option>
													<option>HS Diploma</option>
													<option>Associate Degree</option>
							...
							<div class="reg-fom-btm mt-3">
								<div class="fields">
									<span class="text-white mb-2">Subject</span>
										<select class="form-control">
													<option>Master's Degree</option>
													<option>HS Diploma</option>
													<option>Associate Degree</option>
	...
	<section class="wthree-row w3-about  py-5">
		<div class="container py-md-4 mt-md-3">
			...
			<div class="card-deck mt-md-3 pt-5">
				  <div class="card">
					<img src="startup_assert/images/g1.jpg" class="img-fluid" alt="Card image cap">
				  ...
				  <div class="card">
					<img src="startup_assert/images/g2.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
				  ...
				  <div class="card">
					<img src="startup_assert/images/g3.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
				...
				<div class="footer-title">
					...
					<div class="d-flex justify-content-around">
						<a href="#" class="col-4 fot_tp p-2">
							<img src="startup_assert/images/g1.jpg" class="img-fluid" alt="Responsive image">
						</a>
						<a href="#" class="col-4 fot_tp p-2">
							<img src="startup_assert/images/g2.jpg" class="img-fluid" alt="Responsive image">
						</a>
						<a href="#" class="col-4 fot_tp p-2">
							<img src="startup_assert/images/g3.jpg" class="img-fluid" alt="Responsive image">
						</a>
					</div>
					<div class="d-flex justify-content-around">
						<a href="#" class="col-4 fot_tp p-2">
							<img src="startup_assert/images/g4.jpg" class="img-fluid" alt="Responsive image">
						</a>
						<a href="#" class="col-4 fot_tp p-2">
							<img src="startup_assert/images/g5.jpg" class="img-fluid" alt="Responsive image">
						</a>
						<a href="#" class="col-4 fot_tp p-2">
							<img src="startup_assert/images/g6.jpg" class="img-fluid" alt="Responsive image">
						</a>
					</div>
			</div>
		</div>
...
<!-- Default-JavaScript-File -->
	<script type="text/javascript" src="startup_assert/js/jquery-2.2.3.min.js"></script>
	<script type="text/javascript" src="startup_assert/js/bootstrap.js"></script>
<!-- //Default-JavaScript-File -->
<!--menu script-->
<script type="text/javascript" src="startup_assert/js/modernizr-2.6.2.min.js"></script>
		<script src="startup_assert/js/jquery.fatNav.js"></script>
		<script>
		(function() {
...
<!--Start-slider-script-->
	<script defer src="startup_assert/js/jquery.flexslider.js"></script>
