...
<head>
    ...
    <!-- Main CSS-->
    <link href="survey_assert/css/main.css" rel="stylesheet" media="all">
</head>
...
<body>
    ...
    <!-- Jquery JS-->
    <script src="survey_assert/vendor/jquery/jquery.min.js"></script>


    <!-- Main JS-->
    <script src="survey_assert/js/global.js"></script>
