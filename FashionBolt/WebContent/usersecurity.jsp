...
{
case "a":
window.location="UserLoginData.jsp";
break;
case "b":
window.location="ClientLogin.jsp";
break;
case "c":
window.location="DALoginUser.jsp";
break;


default:
window.location="sup_adminHome.jsp";
break;
}
}
</script>
...
<br>
<h1 style="color: black;"> Login user Data</h1>
<div class="agile-its">
...
<select style="margin-left: 155px;" name="cause" id="s1" name ="section" onChange="SelectRedirect();">
       ...
       <option value="a">Boltz</option>
       <option value="b">CustomerOrder</option>
       <option value="c">Dataadmin</option>
...
<a href="sup_adminHome.jsp" style="margin-left: 180px;" class ="btn btn-outline-success">Go Back</a>
</form>
