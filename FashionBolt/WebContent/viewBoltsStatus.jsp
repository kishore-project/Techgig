...
<input type="file"><a href="" class="btn btn-outline-info" >Submit</a> -->
	<%
		...
		try {
			...
			qtr2 = "select * from decryptionkey where user_Name='" + req
					+ "' and selcprocss='accepted' and user_area='boltz'";
			String query = "select count(*) from decryptionkey where user_Name='" + req + "' and user_area='boltz'";
				...
				<div class="container">
					<h1>
						...
						<button class='btn btn-success pull-right'>
							<a href="updateBoltzordate.jsp">Back</a>
												...
												<tbody>
													...
													<%
														try {
																		...
																		String query2 = "select * from update_boltzorder";
	...
	<div class="container">
		<h1>
			...
			<form action="KeyRequest_Page.jsp" method="post">
				<input type="hidden" name="user" value="boltz">
								...
								<tbody>
									...
									<%
										try {
														...
														Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fashion", "root",
																"root");
														String query2 = "select * from uploadboltzec";
														PreparedStatement ps1 = con.prepareStatement(query2);
														ResultSet s = ps1.executeQuery();
														while (s.next()) {
									%>
  ...
  <div class="button-container">
    <button  class="yes-button"><a href="KeyRequest_Page.jsp?user=boltz">Yes</a></button>
    <button class="no-button"><a href="updateBoltzordate.jsp">No</a></button>
  </div>
</div>
				<<!-- form action="KeyRequest_Page.jsp" method="post">
				<input type="hidden" name="user" value="boltz">
